...
The following figures are generated by running the script on WDBC with default settings.

![Coverage vs alpha](assets/wdbc_coverage_curve.png)
![Efficiency vs alpha](assets/wdbc_efficiency_curve.png)
